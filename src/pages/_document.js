  ...
  return (
    <Html lang="en" style={{ scrollBehavior: "smooth" }}>
      <Head>
        ...
        <meta
          name="description"
          content="HackMOL 4.0 is a 36 hour hackathon organized by the Google Developer Student Clubs from Dr B R Ambedkar National Institute of Technology, Jalandhar."
        ></meta>
