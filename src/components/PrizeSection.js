          ...
          <div className={styles.left_card_content}>
            <div className={styles.left_card_box}>
              <div className={styles.logocontainer}>
                ...
                <img
                  className={styles.logo2prize}
                  src="images/2plogo.png"
                ></img>
              </div>
              <div className={styles.left_card_list}>
                ...
                <List
                  imgsrc="./images/image151.png"
                  content="Others to be Declared soon"
                />
              </div>
            </div>
          </div>
